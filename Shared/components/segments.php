...
function rt_segment_intro(array $rt): void { ?><section class="rt-section rt-intro-section"><p class="rt-kicker">RT Rail Time GmbH</p><h2 class="rt-title" data-reveal><?= $rt['claim'] ?></h2><p class="rt-lead"><?= $rt['about_copy'] ?></p></section><?php }
