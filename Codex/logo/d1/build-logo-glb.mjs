...
// The same 0..1000 frontal geometry used by rt-logo.svg.
const redPolygons = [
  [
...
const darkPolygons = [[
  [0, 184], [686, 184], [686, 386], [436, 386],
  [436, 1000], [229, 1000], [229, 386], [0, 386],
]];
...
const gltf = {
  asset: {
    version: '2.0',
    generator: 'RailTime D1 dependency-free GLB builder',
