    ...
    <div class="rt-map-stage">
        ...
        >
            ...
            <g class="rt-states">
                ...
                <g class="rt-state rt-city-state" id="DE-HH">
                    <title>Hamburg</title>
                    <circle class="rt-state-shape" cx="482" cy="276" r="12" fill="#f4d3bd"></circle>
                </g>
                <g class="rt-state rt-city-state" id="DE-HB">
                    <title>Bremen</title>
                ...
                <g class="rt-state rt-city-state" id="DE-BE">
                    <title>Berlin</title>
