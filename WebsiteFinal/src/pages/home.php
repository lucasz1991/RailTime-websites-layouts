...
<section class="sa-services" id="leistungen"><header class="sa-section-head sa-motion-up"><p class="sa-eyebrow">01 <span></span> Unsere Leistungen</p><h2>F&uuml;nf Leistungsbereiche f&uuml;r einen sicheren Eisenbahnbetrieb</h2><a class="sa-arrow-link" href="leistungen.html">Alle Leistungen <b class="rt-action-arrow" aria-hidden="true"></b></a></header><div class="sa-services__grid"><?php foreach($rt['services'] as $i=>$service): ?><a href="leistungen.html#<?= $service['slug'] ?>" class="sa-service sa-motion-up"><span>0<?= $i+1 ?></span><figure><img src="<?= rt_image($rt['assets']['service_images'][$i]) ?>" alt="<?= htmlspecialchars($service['title'],ENT_QUOTES,'UTF-8') ?>"></figure><h3><?= $service['title'] ?></h3><b class="rt-action-arrow" aria-hidden="true"></b></a><?php endforeach ?></div></section>
<section class="sa-team"><div class="sa-team__visual sa-motion-left"><figure><img src="<?= rt_image('s4.jpg') ?>" alt="Mitarbeiter im Bahnbetrieb"></figure><figure><img src="<?= rt_image('s1.jpg') ?>" alt="Wagenmeister von RT Rail Time"></figure></div><div class="sa-team__copy sa-motion-right"><p class="sa-eyebrow">02 <span></span> &Uuml;ber RT Rail Time</p><h2><?= $rt['about_title'] ?></h2><p><?= $rt['about_copy'] ?></p><a class="sa-arrow-link" href="ueber-uns.html">Unternehmen kennenlernen <b class="rt-action-arrow" aria-hidden="true"></b></a><div class="sa-team__seal"><strong>60+</strong><span>qualifizierte<br>Wagenmeister</span></div></div></section>
