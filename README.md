...
Das Startvideo nutzt layoutübergreifend das echte erste Videoframe `Shared/assets/images/start3-first-frame.png` als Ladeposter. Signal Atlas startet es direkt und stumm, sperrt das Seiten-Scrollen bis zum tatsächlichen Videoende und blendet das D2-3D-Logo framegenau beim Aufprall der Lok bei 5,08 Sekunden ein. Navigation und Hero-Overlays folgen am Videoende; der Hero dockt 1,5 Sekunden nach dem Logo-Reveal auf seine kompakte Höhe.
