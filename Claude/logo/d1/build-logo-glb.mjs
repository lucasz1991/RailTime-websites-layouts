// Claude D1 — GLB-Builder ohne Abhängigkeiten (Methode nach Codex/logo/d1,
// Geometrie mit schmalerer Fuge: 16 statt 30 Einheiten Freiraum um das T).
// Aufruf: node build-logo-glb.mjs
...
const GAP = 16; // dokumentarisch: Fuge zwischen T und R in 0..1000-Einheiten

// Dieselbe 0..1000-Frontgeometrie wie rt-logo.svg (Fuge 16).
const redPolygons = [
  [
    [0, 0], [738, 0], [862, 152], [862, 462], [755, 583], [617, 583],
    [1000, 1000], [731, 1000], [446, 658], [446, 396], [650, 396],
    [696, 350], [696, 216], [654, 174], [0, 174],
  ],
  [[0, 396], [219, 396], [219, 1000], [0, 1000]],
];

const darkPolygons = [[
  [0, 190], [680, 190], [680, 380], [430, 380],
  [430, 1000], [235, 1000], [235, 380], [0, 380],
]];
...
const gltf = {
  asset: {
    version: '2.0',
    generator: 'RailTime Claude D1 GLB builder (narrow gap)',
  ...
  nodes: [
    {
      name: 'RT_Logo',
      children: [1, 2],
      extras: { dimensions: [1, 1, 0.18], frontAxis: '+Z', upAxis: '+Y', gapUnits: GAP },
    },
    { name: 'R_Red', mesh: 0 },
    { name: 'T_Dark', mesh: 1 },
  ],
...
console.log(`Gap ${GAP}/1000; bounds 1 × 1 × ${(HALF_DEPTH * 2).toFixed(2)}; materials: ${materials.length}; meshes: ${meshes.length}`);
